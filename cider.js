...
(function() {
  var Cider, Clock, Entity, Game, GameController, Level, Loader, Map, PlatformerEntity, ciderKeys,
  ...
  */
  ...
  Loader = (function() {
    ...
    function Loader(game, resources) {
      var key, val, _ref;
      this.game = game;
    ...
    Loader.prototype._updateComplete = function() {
      ...
      return console.log(this.percentComplete);
    };
